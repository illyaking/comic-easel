...
foreach ($gnav_directories as $gnav_dirs) {
	...
	<?php }
					...
					<td>
						...
						<?php if ($ceo_options['disable_style_sheet']) { echo '<br /><strong>'; _e('The navstyle.css is disable via the option in the general tab of this config section, this will have no effect.','</strong>','comiceasel'); ?><br /><?php } ?>
					</td>
				</tr>
			</table>
			<br />
