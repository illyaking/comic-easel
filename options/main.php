			...
			<table class="widefat">
				...
				<tr>
					<td>
						...
						<br />
						<?php _e('Via Facebook:','comiceasel'); ?> <a href="https://facebook.com/philip.hofer">https://facebook.com/philip.hofer</a><br />
						<?php _e('WebComics.COM Forums:', 'comiceasel'); ?> <a href="https://webcomics.com/forum/website-design-assistance/">https://webcomics.com/forum/website-design-assistance/</a>  <?php _e('(Subscription only)','comiceasel'); ?><br />
						...
						<?php _e('On Twitter:', 'comiceasel'); ?> <a href="https://twitter.com/Frumph">https://twitter.com/Frumph</a> <?php _e('(Twitter and I are not friends atm)','comiceasel'); ?> <br />
					</td>
				</tr>
			</table>
			<br />
