			...
			<table class="widefat">
				...
				<tr>
					<td>
						...
						<br />
						<?php _e('Via Facebook:','comiceasel'); ?> <a href="http://facebook.com/philip.hofer">https://facebook.com/philip.hofer</a><br />
						...
						<?php _e('On Twitter:', 'comiceasel'); ?> <a href="https://twitter.com/Frumph">http://twitter.com/Frumph</a> <?php _e('(Twitter and I are not friends atm)','comiceasel'); ?> <br />
					</td>
				</tr>
			</table>
			<br />
